  ...
  return (
    <div className="  text-center " style={{ backgroundColor: "#eae9f0ff", minHeight: "100vh", paddingTop: "150px" }}>
      <div className='container'>
        <h1 className="fs-2 fw-bold">NEW CASE STUDY</h1>
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-12 col-md-10 col-lg-8 px-3">
              <h1 className="fw-bold mb-4 text-center fs-3 fs-md-2 fs-lg-1"style={{ lineHeight: "1.4" }}> MISSION IS TO PROTECT YOUR BUSINESS AND MUCH MORE</h1>
